          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{getTotalFeatures()}</p>
              </div>
            </div>
          </div>
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center flex-1">
                              <input
                                ...
                                onChange={() => toggleAllPagePermissions(page.key)}
                              ...
                              <div className="flex items-center flex-1">
                                ...
                                >
                                  <FaKey className="text-lg" style={{ color: page.color || '#059669' }} />
                                </div>
                                <div>
                                  <h3 className="font-semibold text-gray-900 text-base">{page.name}</h3>
                                  <p className="text-xs text-gray-500 mt-0.5">{page.description}</p>
                                </div>
                              </div>
                              <div className="flex items-center space-x-2">
                                <span className="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-1 rounded-full">
                                  {selectedCount} / {page.children.length} chức năng
                                </span>
                              </div>
                            </div>
                          </div>
                                  ...
                                  <div className="flex items-start">
                                    ...
                                    <div className="ml-3 flex-1">
                                      <div className="flex items-start justify-between">
                                        <h4 className="text-sm font-medium text-gray-900 leading-tight">{feature.name}</h4>
                                        {isChecked && (
                                          <div className="bg-green-500 text-white text-xs font-medium px-1.5 py-0.5 rounded ml-2 flex-shrink-0">
                                            ✓
                                          </div>
                                        )}
                                      </div>
